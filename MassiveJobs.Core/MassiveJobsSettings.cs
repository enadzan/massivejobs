namespace MassiveJobs.Core
{
    public class MassiveJobsSettings
    {
        ...
        public string LongRunningQueueNameTemplate { get; set; } = "massivejobs.long-running.{0:#00}";
        public string ScheduledQueueNameTemplate { get; set; } = "massivejobs.scheduled.{0:#00}";
        public string PeriodicQueueNameTemplate { get; set; } = "massivejobs.periodic.{0:#00}";
